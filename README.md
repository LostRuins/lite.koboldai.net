...
Changelog of KoboldAI Lite 1 June 2023:
- Added autogenerated memory option
- Added Claude API
- Added a worker management panel for horde
- Aesthetic chat UI message grouping
- Improved markdown formatting
- Added drag and drop functionality
- Allow forced edit mode even with no story
- Slightly adjusted defaults
- Fixed various bugs and issues with autosave
